...
//calling the I_unroller function to unroll both the initial conditions	
	...
	unrolled_J = iff_replacer(unrolled_J);
	unrolled_J = if_replacer(unrolled_J);
	unrolled_J = negation_remover(unrolled_J);
...
//calling the R_unroller function to unroll both the translation relations		
	...
	unrolled_S = iff_replacer(unrolled_S);
	unrolled_S = if_replacer(unrolled_S);
	unrolled_S = negation_remover(unrolled_S);
