...
//
// 				global_counter ++;
// 				cout << to_string(global_counter) << "=and(" <<  BoolToQCIR(LEFT) << ", " <<  BoolToQCIR(RIGHT) << ")" << endl;
...
//
// 				global_counter ++;
// 				cout << to_string(global_counter) << "=or(" <<  BoolToQCIR(LEFT) << ", " <<  BoolToQCIR(RIGHT) << ")" << endl;
// 				return global_counter;
