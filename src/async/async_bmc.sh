...
echo "\n============ Adding Asynchronous Trajectories ============"
python3 async_formula.py
async_QCIR_OUT=async_HQ.qcir
...
if [ ! -f "$QCIR_OUT" ]; then
    echo "$async_QCIR_OUT not exists"
    exit 1
fi
...
${MAP} ${async_QCIR_OUT} ${QUABS_OUT} ${MAP_OUT1} ${MAP_OUT2}
