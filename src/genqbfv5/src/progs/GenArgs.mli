...
val is_initial_file_C : bool ref
val initial_file_C    : string ref
val is_transition_file_C : bool ref
val transition_file_C    : string ref

val is_initial_file_D : bool ref
val initial_file_D    : string ref
val is_transition_file_D : bool ref
val transition_file_D    : string ref

val is_initial_file_E : bool ref
val initial_file_E    : string ref
val is_transition_file_E : bool ref
val transition_file_E    : string ref
