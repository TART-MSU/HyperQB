...
### timeout setting ### 
TIMEOUT='timeout 120s' # change here for timeout
...
# 11.1 2Square #
###############
# SMV='benchmarks/11_ksafety/doubleSquare.smv'
# HQ='benchmarks/11_ksafety/doubleSquare.hq'
# HQAUTO='benchmarks/11_ksafety/AH/11.hq'
# K=64
# SEM='-pes'
# MODE='-find'
# compare ${SMV} ${HQ} ${K} ${SEM} ${MODE} ${HQAUTO}
