...
class realizability_simplifier(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    polarity = _impl.realizability_simplifier_polarity
    global_equiv = _impl.realizability_simplifier_global_equiv
    global_equiv_output_only = _impl.realizability_simplifier_global_equiv_output_only
