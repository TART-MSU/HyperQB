...
# ### SNARK_concurrent
# M1_NUSMVFILE="./tacas21_cases/snark2_M1_concurrent.smv"
## Try this
# M1_NUSMVFILE="./tacas21_cases/snark2_withtoken_M1_concurrent.smv"
# M1_NUSMVFILE="./tacas21_cases/snark2_with_collision_M1_concurrent.smv"
# M1_NUSMVFILE="./tacas21_cases/snark2_with_collision_M1_concurrent_new.smv"
M1_NUSMVFILE="./tacas21_cases/snark2_new_M1_concurrent.smv"
...
# ### SNARK_sequential
# M2_NUSMVFILE="./tacas21_cases/snark2_M2_sequential.smv"
# M2_NUSMVFILE="./tacas21_cases/snark2_with_collision_M2_sequential.smv"
M2_NUSMVFILE="./tacas21_cases/snark2_new_M2_sequential.smv"



FORMULA="./tacas21_cases/snark2_formula.hq"
# QS=AE	# quantifier selections
k=25	# bound of traces
...
time java ${MAP} ${QCIR_OUT} ${QUABS_OUT} ${MAP_OUT1} ${MAP_OUT2}

# echo "---Parse All Binary Numbers---"
echo "\n============ Get Nice-formatted Output ============"
time java ${PARSE_BOOL} ${MAP_OUT2} ${PARSE_OUT}
